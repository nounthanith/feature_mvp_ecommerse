...
const Shuffle = ({
        ...
        () => {
            ...
            const build = () => {
                ...
                chars.forEach(ch => {
                    ...
                    wrap.className = 'inline-block overflow-hidden align-baseline text-center';
                    Object.assign(wrap.style, { width: w + 'px' });

                    const inner = document.createElement('span');
                    inner.className = 'inline-block whitespace-nowrap will-change-transform origin-center transform-gpu';

                    parent.insertBefore(wrap, ch);
                    wrap.appendChild(inner);

                    const firstOrig = ch.cloneNode(true);
                    firstOrig.className = 'inline-block text-center';
                    Object.assign(firstOrig.style, { width: w + 'px', fontFamily: computedFont });

                    ch.setAttribute('data-orig', '1');
                    ch.className = 'inline-block text-center';
                    ...
                    for (let k = 0; k < rolls; k++) {
                        ...
                        c.className = 'inline-block text-center';
    ...
    const baseTw = 'inline-block whitespace-normal break-words will-change-transform uppercase text-[2rem] md:text-[4rem] leading-none h-[90px]';
